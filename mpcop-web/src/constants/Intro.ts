export class IntroMessage {
	...
	static HOME_PAGE_STATUS: string =
		"This page contains information about the MPCOP state.";
	static PUBLIC_KEY_FIELD: string =
	...
	static PROTOCOL_BUTTONS: string =
